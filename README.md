...
Nano world is a simple app to show a map of the peers of the nano cryptocurrency.
...
Builds the app on docker container 

## `npm run react-docker`

Runs the app on docker container on port 3000
